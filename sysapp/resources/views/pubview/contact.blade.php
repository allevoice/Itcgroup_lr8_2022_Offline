    ...
    <div class="main-contentbox">
        <div class="sub-banner-con darkBlueBg col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="row">
                ...
                <div class="sub-banner-img contact-banner col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <!--banner-img-->
                </div>
                <!--row-->
            </div>
        ...
        <div class="paddingBox col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="container">
                <div class="row text-center">
                    ...
                    <p class="regular-font">Contact us for any questions or suggestions</p>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <aside class="contact-info">
                                    ...
                                    <div class="contact-links regular-font pull-left">
                                        <div> <a href="mailto:info@fcgroup.com">info@itcgrouphaiti.com</a><br>
                                            <a href="mailto:support@fcgroup.com">jsjules@ntpsams.com</a> </div>
                                        <!--contact-links-->
                                    </div>
                                    <!--contact-info-->
                                </aside>
